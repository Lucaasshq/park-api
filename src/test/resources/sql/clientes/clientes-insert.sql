...
insert into CLIENTES (id, nome, cpf, id_usuario) values (10, 'Raissa Barros', '38352600060', 101);
insert into CLIENTES (id, nome, cpf, id_usuario) values (20, 'Bon souza', '17908922015', 102);