...
insert into VAGAS (id, codigo, status ) values (100, 'A-01', 'LIVRE');
insert into VAGAS (id, codigo, status ) values (200, 'A-02', 'LIVRE');
...
insert into clientes_tem_vagas (numero_recibo, placa, marca, modelo, cor, data_entrada, id_cliente, id_vaga)
    values ('20241001-143719', 'ASD-8564', 'Honda', 'Civic Sport', 'Branco', '2024-10-01-14:37:19', 10, 100 );

insert into clientes_tem_vagas (numero_recibo, placa, marca, modelo, cor, data_entrada, id_cliente, id_vaga)
values ('20241001-143719', 'FTA-0456', 'BMW', 'C6', 'Verde', '2024-10-01-14:37:19', 20, 200 );

insert into clientes_tem_vagas (numero_recibo, placa, marca, modelo, cor, data_entrada, id_cliente, id_vaga)
values ('20241001-143719', 'SFQ-6547', 'Toyota', 'Bandeirante', 'Prata', '2024-10-01-14:37:19', 10, 400);